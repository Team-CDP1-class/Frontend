  ...
  return (
    <div>
      ...
      <div className='text-center py-40 bg-myColors-background'>
        ...
        <button className='my-5 button-basic text-white bg-myColors-primary font-bold border-2 border-myColors-primary '>시작하기</button>
      </div>
      ...
      <div className='w-screen text-center py-16 border-t'>
        ...
        <div className='flex justify-center'>
          <div className='card bg-white w-96'>
            ...
            <button className='w-full button-basic text-myColors-primary bg-white
                border-2 border-myColors-primary mt-5 mb-3 hover:text-white hover:bg-myColors-primary hover:font-bold'>바로가기</button>
            {/* -> 스토리카드 */}
          </div>
          <div className='card bg-white w-96'>
